...
function Footer() {
  return (
    ...
    {/* <footer class="p-4 bg-white md:px-6 md:py-8 dark:bg-gray-900">
        <div class="sm:flex sm:items-center sm:justify-between">
            <ul class="items-center mb-6 text-sm text-gray-500 sm:mb-0 dark:text-gray-400">
                <li>
                    <a href=" " class="mr-4 font-2xl cursor-default md:mr-6 ">Service</a>
                </li>
                <li>
